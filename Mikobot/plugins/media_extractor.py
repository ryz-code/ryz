...
from Mikobot.core.decorator.errors import capture_err
from Mikobot.helper.human_read import get_readable_time
from Mikobot.helper.localization import use_chat_lang
from Mikobot.helper.pyro_progress import progress_for_pyrogram
from Mikobot.helper.tools import get_random_string
from Mikobot.plugins.dev import shell_exec
from Mikobot.vars import COMMAND_HANDLER

LOGGER = getLogger("Mikobot")
...
def get_subname(lang, url, ext):
    ...
    if scheme_removed.find("/") == -1 or not get_base_name(
        ...
        return f"[{lang.upper()}] MikobotSub{get_random_string(4)}.{ext}"
